...
- (IBAction)tapGesturePerformed:(UITapGestureRecognizer *)recognizer {
    ...
    //TODO: Figure out how to switch on object vs word type
        ...
        //Shang: for all conditions, show bilingual vocab
        ...
        //Taps on vocab word in story
            ...
            if([chapterTitle isEqualToString:@"The Contest"] && [pageContext.currentPageId containsString:DASH_INTRO] && [englishSentenceText isEqualToString:@"award"]){
             ...
             englishSentenceText = [sc getEnglishTranslation:sentenceText];
             NSString* spanishTxt=[sc getSpanishTranslation:sentenceText];
            [self tapGestureOnStoryWord:sentenceText:sentenceIDNum:spanishTxt:sentenceText];
...
- (void)playAudioForVocabWord:(NSString *)englishSentenceText :(NSString *)spanishExt {
    ...
    //Shang: All condition both language vocab
   // if (conditionSetup.language == BILINGUAL) {
     if (YES) {
        ...
        if ([spanishExt isEqualToString:EMPTYSTRING] == NO) {
         ...
         spanishAudio=[NSString stringWithFormat:@"%@%@.mp3", [englishSentenceText capitalizedString],S];
