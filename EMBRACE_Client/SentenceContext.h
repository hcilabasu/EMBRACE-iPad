...
@property (nonatomic) NSUInteger currentSentence; //Active sentence to be completed
...
@property (nonatomic) NSUInteger currentIdea; //Current idea number to be completed
